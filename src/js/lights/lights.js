...
export function setupLights(scene, camera, qualitySettings) {
    ...
    // Note: mobile spotlight (a moving flashlight that targeted Boisvert) intentionally disabled
    // to avoid applying flashlight effects on mobile devices. Mobile performance and visuals
    // are better without an extra dynamic spotlight.
